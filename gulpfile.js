...
var projectURL = 'localhost.10.1.1.124.xip.io/starter'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
 ...
 */
gulp.task('default', ['styles', 'sprites','admin-styles', 'vendorsJs', 'customJS', 'browser-sync'], function() {
